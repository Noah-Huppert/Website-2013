...
echo "<div class='projectTitle'>" . customQuery('projects', 'projectName', true, 'projectID', $projectID) . "</div>
	<div class='projectDescription'>" . customQuery('projects', 'projectDescription', true, 'projectID', $projectID) . "</div>";
?>
<div id="projectObjects">
	<div id="projectObjectTabs">
		...
		// '<div id="projectIssuesTab" class="projectObjectTab">';
			$sql = "SELECT * FROM `issuelink` WHERE `project`='" . $projectID . "'";
			...
			echo '<a id="projectIssuesTab" class="projectObjectTab" href="' . customQuery('issuelink', 'link',  true, 'project', $projectID) . '" style="text-decoration: none; color: #EB3434">Issues</a>';
		//echo '</div>';
		?>
		<div id="projectTasks">
			<?php
